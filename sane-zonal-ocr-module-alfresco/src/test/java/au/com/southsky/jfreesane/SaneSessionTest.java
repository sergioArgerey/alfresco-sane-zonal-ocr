package au.com.southsky.jfreesane.test;
...
public class SaneSessionTest {
  ...
  public void initSession() throws Exception {
    this.session = SaneSession.withRemoteSane(InetAddress.getByName("192.168.1.193"));
  }
  ...
  public void openDeviceSucceeds() throws Exception {
    SaneDevice device = session.getDevice("fujitsu:ScanSnap iX500:1740");
    try {
      device.open();
    } finally {
  ...
  public void optionGroupsArePopulated() throws Exception {
    ...
    try {
      ...
      List<OptionGroup> list = device.getOptionGroups();
      for(OptionGroup opGr: list){
    	  for(SaneOption op: opGr.getOptions()){
    		  log.info(op.getName() + " - " + op.getType());
    	  }
      }
    } finally {
      Closeables.closeQuietly(device);
...
//	  SaneSessionTest test = new SaneSessionTest();
//	  try {
//		test.initSession();
//	} catch (Exception e2) {
//		log.info("init");
...
//
//	try {
//		test.listOptionsSucceeds();
//	} catch (Exception e) {
//		log.info("listOptions");
//		e.printStackTrace();
//	}
//
//	try {
//		test.imageAcquisitionSucceeds();
//	} catch (Exception e) {
//		// TODO Auto-generated catch block
//		e.printStackTrace();
//	}
